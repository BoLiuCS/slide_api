...
// u ===>e
// new U()['encrypt'](random())             //this[$_CBFJv(761)](t) ===>random()  rsa加密
...
function HHH(t, e) {
      ...
      for (; $_DAJEw !== _tkts.$_Dm()[0][9];) {
        switch ($_DAJEw) {
          case _tkts.$_Dm()[0][10]:
            for (var n = e[_tkts.$_Ch(195)](-2), r = [], i = 0; i < n[_tkts.$_Ch(159)]; i++) {
              var o = n[_tkts.$_Ch(168)](i);
              r[i] = 57 < o ? o - 87 : o - 48;
            }
            n = 36 * r[0] + r[1];
            var s,
              a = Math[_tkts.$_Ch(187)](t) + n,
              _ = [[], [], [], [], []],
              c = {},
              u = 0;
            i = 0;
            for (var l = (e = e[_tkts.$_Ch(195)](0, -2))[_tkts.$_Ch(159)]; i < l; i++) c[s = e[_tkts.$_Ch(176)](i)] || (c[s] = 1, _[u][_tkts.$_Ch(105)](s), u = 5 == ++u ? 0 : u);
            var h,
              f = a,
              d = 4,
              p = _tkts.$_Ch(82),
              g = [1, 2, 5, 10, 50];
            while (0 < f) 0 <= f - g[d] ? (h = parseInt(Math[_tkts.$_Ch(57)]() * _[d][_tkts.$_Ch(159)], 10), p += _[d][h], f -= g[d]) : (_[_tkts.$_Ch(166)](d, 1), g[_tkts.$_Ch(166)](d, 1), d -= 1);
            return p;
            break;
        }
      }
...
function $_FDL(xy) {
    ...
    var t = function(t) {
      ...
      , i = []
      , o = [];
    this[_tkts.$_Ch(474)] = t
    return $_CAd(function(t) {
...
function get_h(o, random) {
    l = aesV(JSON.stringify(o), random)
    h = $_FCc(l)
    return h
}
// '50'+ '7f7c26b7359a38c21f3ea4630bc8b332ce'
//

var False = false
var True = true
// console.log(HHH(50, '7f7c26b7359a38c21f3ea4630bc8b332ce'))
// console.log(get_aa([[-44, -37, 0], [0, 0, 0], [10, 0, 101], [19, 0, 118], [27, 0, 134], [35, 0, 150], [43, 0, 161], [50, 0, 176], [56, 0, 192], [63, 0, 206], [68, 0, 216], [74, 0, 234], [79, 0, 250], [84, 0, 270], [88, 0, 282], [92, 0, 293], [96, 0, 312], [100, 0, 327], [104, 0, 340], [107, 0, 360], [110, 0, 374], [113, 0, 388], [115, 0, 403], [118, 0, 421], [120, 0, 436], [123, 0, 456], [125, 0, 476], [127, 0, 492], [128, 0, 509], [130, 0, 527], [132, 0, 543], [133, 0, 563], [135, 0, 581], [136, 0, 598], [137, 0, 618], [138, 0, 633], [139, 0, 649], [141, 0, 660], [142, 0, 693], [143, 0, 704], [144, 0, 723], [145, 0, 741], [146, 0, 764], [147, 0, 779], [148, 0, 817], [149, 0, 847], [150, 0, 873], [151, 0, 920], [152, 0, 962], [153, 0, 1028], [154, 0, 1098], [155, 0, 1222], [156, 0, 1455], [156, 0, 1455]],[12, 58, 98, 36, 43, 95, 62, 15, 12],'2a337155'))
// console.log(aesV('50', '7f7c26b7359a38c21f3ea4630bc8b332ce'))
// console.log(get_aa('[[-21,-45,0], [0,0,0], [9, 0, 96], [17, 0, 110], [25, 0, 123], [33, 0, 141], [39, 0, 151]]', 'c0f0aedae0958e4b1db6d2b8fa6c1832iy'))
// console.log(get_h({'lang': 'zh-cn', 'userresponse': 'cc29f54', 'passtime': 1231, 'imgload': 243, 'aa': '321100///.-----!!O((((((((((((((yyyttyFttstsstssstsssssssssssss!!($)U79A89656:8:?34A:74:7@:36A96?49M:89S@QZH$)0g$)EM$,D', 'ep': {'v': '7.9.0', '$_BIo': False, 'me': True, 'tm': {'a': 1681368670117, 'b': 1681368670842, 'c': 1681368670842, 'd': 0, 'e': 0, 'f': 1681368670121, 'g': 1681368670124, 'h': 1681368670151, 'i': 1681368670151, 'j': 1681368670269, 'k': 1681368670165, 'l': 1681368670269, 'm': 1681368670823, 'n': 1681368670832, 'o': 1681368670843, 'p': 1681368671007, 'q': 1681368671007, 'r': 1681368671008, 's': 1681368671008, 't': 1681368671008, 'u': 1681368671008}, 'td': -1}, 'h9s9': '1816378497', 'rp': '4d057e738c071269ab60945088abcecc'},'e06879c44e208a8e'))
console.log(get_h({'lang': 'zh-cn', 'passtime': 1623, 'a': '1830_6359,3169_12572', 'pic': '/captcha_v3/batch/v3/37195/2023-06-04T21/word/e9299b9d91fe4ba4a0775a7156785461.jpg', 'tt': 'M:S5-Up8MN(Up8Pjp*-Up8Pjp8Pjp8ON3(R)(*1*3S/()NNOW(//)NNM(EE(E*U///1W(///EFS)M(K//,M)Q).75-@-AK*/)BE1/M9:OMb:@Ag7,).7*).7*N.Bco:C@B,O*).7)).71/-Aj9-Aj--QfBjM9:@MU:@:@Nj?-QNESc.7,).7)).7,N.JP.cYb?-Qj9-Aj--Aj--G)(gK*)1M9?1--cOnME?-N1?)*1?-EU5-AjK-gd*5).6.S)(j0321*Raben(,(b(((,ne,eb(,5b,(b((nb585(e,58((((5e,(n8(5(,e55(83WN(,)(E5(15-)4)Mn/.bEFhJUL))R:I--5P1*(M-)*)(E-(MM-1?)*)M?/)(U1)3)(1/)(?-)*)(9MM-U/)(N*)(?-U-)1*-N(E-(M9-U-)1?M9-NME3*(?Mb-*(U1)3*M?/)(NM91?M9/)MN(N19-M1*MU-1-)3)(?/)(N1j-*Mb6,M9?)(g2,ME1d(M3)(E5(/)()Mj(9bU-*(MbE/)M0qqn((((((((()j)YIn8(qe8,qq8n,(5e(q,b5,,5(b5e5b,,,(58HY-),*(E-(-5-)Pb(9/0M1z-)M9*)M9M9-1-)M9(MME/)(U-(M9/)(1/)M9(U-(M9/)M1-)(9M9-)(E/(3)()M9(9//(5-)M9(9b9/)()(EG(-)M9(9b9-5-)(9/)()(E1(/)M)Q1(EQ(3*(?-NM91@MM1dM95P1j/@*-U-)ME)b)/qp(((', 'ep': {'ca': [{'x': 186, 'y': 380, 't': 0, 'dt': 2811}, {'x': 140, 'y': 476, 't': 0, 'dt': 856}, {'x': 267, 'y': 448, 't': 0, 'dt': 768}, {'x': 298, 'y': 598, 't': 3, 'dt': 980}], 'v': '3.0.8', 'te': False, 'me': True, 'tm': {'a': 1684403250977, 'b': 1684403251136, 'c': 1684403251168, 'd': 0, 'e': 0, 'f': 1684403250988, 'g': 1684403251003, 'h': 1684403251003, 'i': 1684403251003, 'j': 1684403251033, 'k': 1684403251013, 'l': 1684403251033, 'm': 1684403251059, 'n': 1684403251098, 'o': 1684403251175, 'p': 1684403251811, 'q': 1684403251812, 'r': 1684403251812, 's': 0, 't': 0, 'u': 0}}, 'h9s9': '1816378497', 'rp': '62a02f60db320879979be1b3283e3941'}, '85fa1904ec5031b2'))
